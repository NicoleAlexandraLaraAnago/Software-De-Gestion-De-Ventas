...
import static Modelo.Eventos.convertToUpperCase;
...
public class Sistema extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LabelVendedor.setText("Impulsor,Inc");
    ...
    private void btnPdfVentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPdfVentasActionPerformed
        ...
        if (txtIdVenta.getText().equals("")) {
            ...
            v = Vdao.getVenta(id);
            Vdao.pdfV(id, v.getIdcliente(), v.getTotal(), v.getVendedor());
    ...
    private void txtCodigoProKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodigoProKeyReleased
        ...
        txtCodigoPro.setText(convertToUpperCase(txtCodigoPro.getText()));
        // TODO add your handling code here:
    ...
    private void RegistrarVenta() {
        int cliente = Integer.parseInt(txtIdCli.getText());
    ...
    private void RegistrarDetalle() {
        ...
        Vdao.pdfV(id, idCliente, Totalpagar, LabelVendedor.getText());
