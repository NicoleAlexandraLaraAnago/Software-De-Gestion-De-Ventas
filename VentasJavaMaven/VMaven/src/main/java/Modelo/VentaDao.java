...
public class VentaDao {
    ...
    public Venta getVenta(int id) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                vt.setIdcliente(rs.getInt("cliente"));
    ...
    public void pdfV(int idventa, int Cliente, double total, String usuario) {
        try {
            ...
            doc.open();
            Image img = Image.getInstance(getClass().getResource("/img/proyecto.png"));
            //Fecha
            ...
            tabla.addCell(c3);
            tabla.addCell(c4);
            String product = "SELECT d.precio, d.cantidad, p.nombre FROM detalle d INNER JOIN productos p ON d.cod_pro = p.codigo WHERE d.id_venta = ?";
            ...
            gr.add("GRACIAS POR LA PREFERENCIA");
